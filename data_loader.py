...
def mnist_noniid_s(dataset, num_users, noniid_s=20, local_size=600, random_labels=[], train=True):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
    ...
    s = noniid_s / 100
    num_per_user_list = [300, 900, 1500]

    if train:
        print(f'clients number are selected from: {num_per_user_list}')
    ...
    for i in range(num_users):
        num_per_user = np.random.choice(num_per_user_list) if train else 300
        if train:
            print(f'samples num of user {i}: {num_per_user}')
        ...
        # rand_label = np.sort(np.random.choice(10, size=np.random.randint(3, 8), replace=False)).tolist()
        if train:
            # size = np.random.randint(2, 3)
            size = np.random.randint(3, 8)
            # size = np.random.randint(5, 6)
            rand_label = np.sort(np.random.choice(10, size=size, replace=False)).tolist()
            random_labels.append(rand_label)
        else:
            rand_label = random_labels[i]
        if train:
            print(f'class for client {i} is {rand_label}')
        else:
            print(f'class for client {i} is {rand_label}')
    ...
    return dict_users, LABELS, idxs, random_labels


# Extended-MNIST
def emnist_noniid_s_original(dataset, num_users, train=True, noniid_s=20, local_size=1000):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
...
def emnist_noniid_s(dataset, num_users, noniid_s=20, local_size=600, random_labels=[], train=True):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
    ...
    num_per_user_list = [900, 1500, 3000]
    ...
    for i in range(num_users):
        num_per_user = np.random.choice(num_per_user_list) if train else 300
        if train:
            print(f'total samples of user {i}: {num_per_user}')
        num_imgs_iid = int(num_per_user * s)
        num_imgs_noniid = num_per_user - num_imgs_iid
        iid_per_label = int(num_imgs_iid / num_classes)
        iid_per_label_last = num_imgs_iid - (num_classes - 1) * iid_per_label
        ...
        if train:
            ...
            size = np.random.choice(range(18, 43, 3))
            rand_label = np.sort(np.random.choice(62, size=size, replace=False)).tolist()
            random_labels.append(rand_label)
        else:
            rand_label = random_labels[i]
        if train:
        ...
        # ver.2
        # rand_label = np.sort(np.random.choice(62, size=np.random.randint(20, 40), replace=False)).tolist()
        noniid_labels = len(rand_label)
        noniid_per_num = int(num_imgs_noniid / noniid_labels)
        noniid_per_num_last = num_imgs_noniid - noniid_per_num * (noniid_labels - 1)
        label_cnt = 0
...
def cifar_noniid_s(dataset, num_users, noniid_s=20, local_size=600, random_labels=[], train=True):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
...
def cifar100_noniid_s(dataset, num_users, noniid_s=20, local_size=600, random_labels=[], train=True):
    """
    Sample non-I.I.D client data from MNIST dataset
    :param dataset:
    :param num_users:
    ...
    for i in range(num_users):
        ...
        if train:
            size = np.random.randint(50, 51)
            size = np.random.choice(range(30, 71, 5))
            rand_label = np.sort(np.random.choice(100, size=size, replace=False)).tolist()
            random_labels.append(rand_label)
        else:
            rand_label = random_labels[i]
        if train:
...
def cinic10_noniid_s(dataset, num_users, noniid_s=20, local_size=600, random_labels=[], train=True):
    """
    Sample non-I.I.D client data from cinic10 dataset
    :param dataset:
    :param num_users:
    :return:
    """
...
def get_dataset(args):
    ...
    if args.dataset in ['cifar', 'cifar10']:
        ...
        if args.iid:
            ...
            user_groups_train, LABELS_train, IDXS, random_labels = cifar_noniid_s(train_dataset, args.num_users,
                                                                                  args.noniid_s, args.local_size,
                                                                                  [], train=True)

            # add start
            class_cnt_lst = []
            for key in user_groups_train:
                value = user_groups_train[key]
                temp_list = []
                for item in value:
                    temp_list.append(LABELS_train[np.where(IDXS == item)].item())
                class_cnt_lst.append(temp_list)

            if args.noniid_s == 0:
                count_list = [[sublist.count(i) for i in range(0, 10)] for sublist in class_cnt_lst]
            else:
                count_list = [[sublist.count(i) for i in range(min(sublist), max(sublist) + 1)] for sublist in
                              class_cnt_lst]
            ...
            user_groups_test, LABELS_test, IDXS, _ = cifar_noniid_s(test_dataset, args.num_users, args.noniid_s,
                                                                 args.local_size, random_labels, train=False)
        ...
        if args.iid:
            ...
            # Sample Non-IID user data
            user_groups_train, LABELS_train, IDXS, random_labels = cifar100_noniid_s(train_dataset, args.num_users, args.noniid_s,
                                                                    args.local_size, [], train=True)
            ...
            if args.noniid_s == 0:
                count_list = [[sublist.count(i) for i in range(0, 100)] for sublist in class_cnt_lst]
            else:
                count_list = [[sublist.count(i) for i in range(min(sublist), max(sublist) + 1)] for sublist in
                              class_cnt_lst]
            ...
            user_groups_test, LABELS_test, IDXS, _ = cifar100_noniid_s(test_dataset, args.num_users, args.noniid_s,
                                                                  args.local_size, random_labels, train=False)
            print('non-IID Data Loading---')
        ...
        if args.iid:
            ...
            # Sample Non-IID user data
            user_groups_train, LABELS_train, IDXS, random_labels = cinic10_noniid_s(train_dataset, args.num_users, args.noniid_s,
                                                                   args.local_size, [], train=True)
            ...
            user_groups_test, LABELS_test, IDXS, _ = cinic10_noniid_s(test_dataset, args.num_users, args.noniid_s,
                                                                 args.local_size, random_labels, train=False)
            print('non-IID Data Loading---')
        ...
        if args.iid:
            ...
            user_groups_train1, user_groups_train2 = cinic_separate_noniid_s(train_dataset1, train_dataset2,
                                                                             args.num_users, args.noniid_s,
                                                                             args.local_size, train=True)
            user_groups_test1, user_groups_test2 = cinic_separate_noniid_s(test_dataset1, test_dataset2, args.num_users,
                                                                           args.noniid_s, args.local_size, train=False)
        ...
        if args.iid:
            ...
            # Sample Non-IID user data
            user_groups_train, LABELS_train, IDXS, random_labels = mnist_noniid_s(train_dataset, args.num_users, args.noniid_s,
                                                                   args.local_size, [], train=True)
            ...
            user_groups_test, LABELS_test, IDXS, _ = mnist_noniid_s(test_dataset, args.num_users, args.noniid_s,
                                                                 args.local_size, random_labels, train=False)
            print('non-IID Data Loading---')
        ...
        if args.iid:
            ...
            # Sample Non-IID user data
            user_groups_train, LABELS_train, IDXS, random_labels = emnist_noniid_s(train_dataset, args.num_users, args.noniid_s,
                                                                    args.local_size, [], train=True)
            ...
            if args.noniid_s == 0:
                count_list = [[sublist.count(i) for i in range(0, 62)] for sublist in class_cnt_lst]
            else:
                count_list = [[sublist.count(i) for i in range(min(sublist), max(sublist) + 1)] for sublist in
                              class_cnt_lst]
            ...
            user_groups_test, LABELS_test, IDXS, _ = emnist_noniid_s(test_dataset, args.num_users, args.noniid_s,
                                                                  args.local_size, random_labels, train=False)
            print('non-IID Data Loading---')
    ...
    return train_loader, test_loader, global_test_loader, count_list
